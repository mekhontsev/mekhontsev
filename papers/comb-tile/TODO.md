...
This file tracks pending improvements to the article. When working on tasks:
1. Pick an item, make the change, mark it [x] here in the same commit.
2. Prefer batching multiple small fixes into one commit/PR.
3. The .tex file is `papers/comb-tile/comb-tile-article.tex`.